...
os.chdir('/home/Aleksandr/') 
model_trainer = ModelTraining()
# model_trainer.setModelTypeAsResNet()
model_trainer.setModelTypeAsResNet()
model_trainer.setDataDirectory("trainimages4")
...
model_trainer.trainModel(num_objects=20, num_experiments=500, enhance_data=True, batch_size=32, show_network_summary=True, save_full_model = True )#
